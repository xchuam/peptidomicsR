...
`peptidomicsR` provides functions to process, filter, analyze, and visualize peptidomics data, especially from MaxQuant protein digestion studies. This README introduces the current package through four parts:
...
-   Import MaxQuant *peptides.txt* file, intensity-column metadata, and protein mapping.
...
#| fig-width: !expr attr(p_align, "suggested_fig_width")
#| fig-height: !expr attr(p_align, "suggested_fig_height")
p_align
```
